...
* [Esplora](https://github.com/Blockstream/esplora) ⭐ 1,261 | 🐛 190 | 🌐 JavaScript | 📅 2026-08-14 - Self-hosted blockchain explorer.
...
* [libsecp256k1](https://github.com/bitcoin-core/secp256k1) ⭐ 2,473 | 🐛 153 | 🌐 C | 📅 2026-08-16
...
* [Bitcoinjs-lib](https://github.com/bitcoinjs/bitcoinjs-lib) ⭐ 5,997 | 🐛 52 | 🌐 JavaScript | 📅 2026-02-17
* [Bitcore Library](https://github.com/bitpay/bitcore/tree/v8.0.0/packages/bitcore-lib) ⭐ 4,990 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-06
* [bcoin](https://github.com/bcoin-org/bcoin) ⭐ 3,066 | 🐛 201 | 🌐 JavaScript | 📅 2024-02-12 - Javascript bitcoin library for node.js and browsers.
...
* [toll-booth](https://github.com/forgesworn/toll-booth) ⭐ 2 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-16 - HTTP 402 payment middleware for Node.js; gates any API behind Lightning, Cashu, or stablecoin payments with five backend options.
...
* [Rust Bitcoin](https://github.com/rust-bitcoin/rust-bitcoin) ⭐ 2,652 | 🐛 485 | 🌐 Rust | 📅 2026-08-16 - support for de/serialization, parsing and executing on data-structures and network messages.
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 496,376 | 🐛 100 | 📅 2026-06-30 list thing.
