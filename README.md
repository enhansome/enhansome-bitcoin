...
* [Esplora](https://github.com/Blockstream/esplora) ⭐ 1,263 | 🐛 187 | 🌐 JavaScript | 📅 2026-09-08 - Self-hosted blockchain explorer.
...
* [libsecp256k1](https://github.com/bitcoin-core/secp256k1) ⭐ 2,483 | 🐛 157 | 🌐 C | 📅 2026-09-09
* [UltrafastSecp256k1](https://github.com/shrec/UltrafastSecp256k1) ⭐ 52 | 🐛 2 | 🌐 C++ | 📅 2026-09-08 - High-performance `secp256k1` engine with a stable C ABI, CPU, CUDA, OpenCL, embedded, and WebAssembly targets.
...
* [Bitcore Library](https://github.com/bitpay/bitcore/tree/v8.0.0/packages/bitcore-lib) ⭐ 4,986 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-09
...
* [Rust Bitcoin](https://github.com/rust-bitcoin/rust-bitcoin) ⭐ 2,677 | 🐛 474 | 🌐 Rust | 📅 2026-09-09 - support for de/serialization, parsing and executing on data-structures and network messages.
...
* [nodsig](https://github.com/amenano/nodsig) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-09 - Turns your node's blocks into sealed local artifacts: chain questions become offline lookups, and every answer carries a fingerprint anyone can recompute. Python stdlib only.

## Full nodes

* [btcd](https://github.com/btcsuite/btcd/) ⭐ 6,704 | 🐛 348 | 🌐 Go | 📅 2026-09-09 - Go-based full node since 2013.
* [Bitcore](https://github.com/bitpay/bitcore) ⭐ 4,986 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-09 - Formerly just a Nodejs library, now a full node.
...
* [Mastering Bitcoin](https://github.com/bitcoinbook/bitcoinbook) ⭐ 25,301 | 🐛 191 | 🌐 HTML | 📅 2024-12-26
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,475 | 🐛 106 | 📅 2026-09-02 list thing.
