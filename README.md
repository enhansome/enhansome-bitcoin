...
* [PaperVault](https://github.com/boazeb/papervault) ⭐ 62 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-12 - Offline paper-based secret storage using AES-256-GCM and Shamir's Secret Sharing. Create printable encrypted backups of seed phrases with threshold key splitting.
...
* [Esplora](https://github.com/Blockstream/esplora) ⭐ 1,259 | 🐛 190 | 🌐 JavaScript | 📅 2026-08-11 - Self-hosted blockchain explorer.
...
* [Chainradar API](https://github.com/yasaricli/chainradar-api) ⭐ 4 | 🐛 1 | 🌐 JavaScript | 📅 2018-09-01 - Blockchain Explorer API for Chainradar.
...
* [libsecp256k1](https://github.com/bitcoin-core/secp256k1) ⭐ 2,472 | 🐛 153 | 🌐 C | 📅 2026-08-04
* [UltrafastSecp256k1](https://github.com/shrec/UltrafastSecp256k1) ⭐ 50 | 🐛 4 | 🌐 C++ | 📅 2026-08-10 - High-performance `secp256k1` engine with a stable C ABI, CPU, CUDA, OpenCL, embedded, and WebAssembly targets.

## C++ Libraries

* [Libbitcoin](https://libbitcoin.org/)
* [Libbitcoin](https://libbitcoin.info/) - A set of cross platform C++ libraries for building bitcoin applications
* [libwally-core](https://github.com/ElementsProject/libwally-core) ⭐ 305 | 🐛 32 | 🌐 C | 📅 2026-08-10

## JavaScript Libraries

* [Bitcoinjs-lib](https://github.com/bitcoinjs/bitcoinjs-lib) ⭐ 5,997 | 🐛 51 | 🌐 JavaScript | 📅 2026-02-17
* [Bitcore Library](https://github.com/bitpay/bitcore/tree/v8.0.0/packages/bitcore-lib) ⭐ 4,989 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-06
* [bcoin](https://github.com/bcoin-org/bcoin) ⭐ 3,066 | 🐛 202 | 🌐 JavaScript | 📅 2024-02-12 - Javascript bitcoin library for node.js and browsers.
* [noble-curves](https://github.com/paulmillr/noble-curves) ⭐ 935 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-13 — audited implementation of secp256k1 + schnorr in pure typescript
* [noble-secp256k1](https://github.com/paulmillr/noble-secp256k1) ⭐ 881 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-10 — alternative implementation of secp256k1: size is only 4KB gzipped; lots of comments, very valuable for learning how algorithms work
* [scure-btc-signer](https://github.com/paulmillr/scure-btc-signer) ⭐ 237 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-08 — audited & minimal library for creating, signing & decoding Bitcoin transactions. With Schnorr, Taproot, UTXO & PSBT.
...
* [toll-booth](https://github.com/forgesworn/toll-booth) ⭐ 2 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-11 - HTTP 402 payment middleware for Node.js; gates any API behind Lightning, Cashu, or stablecoin payments with five backend options.
...
* [bitcoinrb](https://github.com/chaintope/bitcoinrb) ⭐ 67 | 🐛 1 | 🌐 Ruby | 📅 2026-08-09 - Ruby bitcoin library including script interpreter.
...
* [Rust Bitcoin](https://github.com/rust-bitcoin/rust-bitcoin) ⭐ 2,654 | 🐛 484 | 🌐 Rust | 📅 2026-08-13 - support for de/serialization, parsing and executing on data-structures and network messages.
...
* [XChange](https://github.com/knowm/XChange) ⭐ 4,080 | 🐛 194 | 🌐 Java | 📅 2026-07-31 - Library that provides a simple and consistent API for interacting with 50+ Bitcoin currency exchanges.
* [Bitcoin Spring Boot Starter](https://github.com/theborakompanioni/bitcoin-spring-boot-starter) ⭐ 85 | 🐛 15 | 🌐 Java | 📅 2026-07-30 - Bitcoin integration for Spring Boot applications.
...
* [Haskoin-core](https://github.com/haskoin/haskoin-core) ⭐ 534 | 🐛 2 | 🌐 Haskell | 📅 2026-08-12 - Haskoin Core is a library of Bitcoin and Bitcoin Cash functions written in Haskell.

## Playgrounds

* [blockchain-demo](https://github.com/anders94/blockchain-demo/) ⭐ 5,659 | 🐛 11 | 🌐 Pug | 📅 2026-07-29 - A web-based demonstration of blockchain concepts.
...
* [btcd](https://github.com/btcsuite/btcd/) ⭐ 6,697 | 🐛 342 | 🌐 Go | 📅 2026-08-12 - Go-based full node since 2013.
* [Bitcore](https://github.com/bitpay/bitcore) ⭐ 4,989 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-06 - Formerly just a Nodejs library, now a full node.
...
* [Mastering Bitcoin](https://github.com/bitcoinbook/bitcoinbook) ⭐ 25,284 | 🐛 191 | 🌐 HTML | 📅 2024-12-26
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,066 | 🐛 100 | 📅 2026-06-30 list thing.
