...
* [PaperVault](https://github.com/boazeb/papervault) ⭐ 66 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-10 - Offline paper-based secret storage using AES-256-GCM and Shamir's Secret Sharing. Create printable encrypted backups of seed phrases with threshold key splitting.
...
* [libsecp256k1](https://github.com/bitcoin-core/secp256k1) ⭐ 2,483 | 🐛 156 | 🌐 C | 📅 2026-09-10
* [UltrafastSecp256k1](https://github.com/shrec/UltrafastSecp256k1) ⭐ 52 | 🐛 2 | 🌐 C++ | 📅 2026-09-09 - High-performance `secp256k1` engine with a stable C ABI, CPU, CUDA, OpenCL, embedded, and WebAssembly targets.
...
* [Bitcoinjs-lib](https://github.com/bitcoinjs/bitcoinjs-lib) ⭐ 5,997 | 🐛 54 | 🌐 JavaScript | 📅 2026-02-17
* [Bitcore Library](https://github.com/bitpay/bitcore/tree/v8.0.0/packages/bitcore-lib) ⭐ 4,985 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-10
...
* [Bitcoin-ruby](https://github.com/lian/bitcoin-ruby) ⭐ 922 | 🐛 39 | 🌐 Ruby | 📅 2024-08-19
...
* [Rust Bitcoin](https://github.com/rust-bitcoin/rust-bitcoin) ⭐ 2,677 | 🐛 478 | 🌐 Rust | 📅 2026-09-09 - support for de/serialization, parsing and executing on data-structures and network messages.
...
* [Bitcoin Spring Boot Starter](https://github.com/theborakompanioni/bitcoin-spring-boot-starter) ⭐ 85 | 🐛 16 | 🌐 Java | 📅 2026-09-10 - Bitcoin integration for Spring Boot applications.
...
* [blockchain-demo](https://github.com/anders94/blockchain-demo/) ⭐ 5,663 | 🐛 11 | 🌐 Pug | 📅 2026-09-10 - A web-based demonstration of blockchain concepts.
...
* [nodsig](https://github.com/amenano/nodsig) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-10 - Turns your node's blocks into sealed local artifacts: chain questions become offline lookups, and every answer carries a fingerprint anyone can recompute. Python stdlib only.

## Full nodes

* [btcd](https://github.com/btcsuite/btcd/) ⭐ 6,704 | 🐛 348 | 🌐 Go | 📅 2026-09-09 - Go-based full node since 2013.
* [Bitcore](https://github.com/bitpay/bitcore) ⭐ 4,985 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-10 - Formerly just a Nodejs library, now a full node.
...
* [Mastering Bitcoin](https://github.com/bitcoinbook/bitcoinbook) ⭐ 25,304 | 🐛 191 | 🌐 HTML | 📅 2024-12-26
* [Bitcoin Book of BIPs](https://adamdecaf.github.io/bitcoin-bips-book/) - Deployed and complete [BIPs](https://github.com/bitcoin/bips) ⭐ 10,931 | 🐛 57 | 🌐 Wikitext | 📅 2026-09-10, grouped by theme. PDF, ePUB, and web.
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,754 | 🐛 106 | 📅 2026-09-02 list thing.
