...
* [libsecp256k1](https://github.com/bitcoin-core/secp256k1) ⭐ 2,477 | 🐛 154 | 🌐 C | 📅 2026-08-24
* [UltrafastSecp256k1](https://github.com/shrec/UltrafastSecp256k1) ⭐ 51 | 🐛 11 | 🌐 C++ | 📅 2026-08-24 - High-performance `secp256k1` engine with a stable C ABI, CPU, CUDA, OpenCL, embedded, and WebAssembly targets.
...
* [secp256k1.swift](https://github.com/GigaBitcoin/secp256k1.swift) ⭐ 157 | 🐛 3 | 🌐 Swift | 📅 2026-08-24 - Swift package for secp256k1 applications, includes Elliptic Curve operations, Schnorr, ZKP and more for Bitcoin.
...
* [Mastering Bitcoin](https://github.com/bitcoinbook/bitcoinbook) ⭐ 25,293 | 🐛 191 | 🌐 HTML | 📅 2024-12-26
