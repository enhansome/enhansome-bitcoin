...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,189 | 🐛 106 | 📅 2026-09-02
...
* [Pycoin](https://github.com/richardkiss/pycoin) ⭐ 1,440 | 🐛 19 | 🌐 Python | 📅 2026-06-18 - Python-based Bitcoin and alt-coin utility library.
...
* [bx](https://github.com/libbitcoin/libbitcoin-explorer) ⭐ 643 | 🐛 20 | 🌐 C++ | 📅 2024-03-01 - Bitcoin Command Line Tool.
* [Nigiri](https://github.com/vulpemventures/nigiri/) ⭐ 330 | 🐛 45 | 🌐 Go | 📅 2026-07-10 - CLI to quickly fire up a a Bitcoin regtest box along with Electrs and Esplora. Includes faucet and push commands.
...
* [PaperVault](https://github.com/boazeb/papervault) ⭐ 66 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-05 - Offline paper-based secret storage using AES-256-GCM and Shamir's Secret Sharing. Create printable encrypted backups of seed phrases with threshold key splitting.
...
* [Esplora](https://github.com/Blockstream/esplora) ⭐ 1,263 | 🐛 190 | 🌐 JavaScript | 📅 2026-09-04 - Self-hosted blockchain explorer.
...
* [libsecp256k1](https://github.com/bitcoin-core/secp256k1) ⭐ 2,483 | 🐛 158 | 🌐 C | 📅 2026-09-08
* [UltrafastSecp256k1](https://github.com/shrec/UltrafastSecp256k1) ⭐ 52 | 🐛 1 | 🌐 C++ | 📅 2026-09-08 - High-performance `secp256k1` engine with a stable C ABI, CPU, CUDA, OpenCL, embedded, and WebAssembly targets.

## C++ Libraries

* [Libbitcoin](https://libbitcoin.org/)
* [Libbitcoin](https://libbitcoin.info/) - A set of cross platform C++ libraries for building bitcoin applications
* [libwally-core](https://github.com/ElementsProject/libwally-core) ⭐ 307 | 🐛 34 | 🌐 C | 📅 2026-09-04

## JavaScript Libraries

* [Bitcoinjs-lib](https://github.com/bitcoinjs/bitcoinjs-lib) ⭐ 5,996 | 🐛 54 | 🌐 JavaScript | 📅 2026-02-17
* [Bitcore Library](https://github.com/bitpay/bitcore/tree/v8.0.0/packages/bitcore-lib) ⭐ 4,986 | 🐛 61 | 🌐 TypeScript | 📅 2026-08-31
...
* [noble-curves](https://github.com/paulmillr/noble-curves) ⭐ 953 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-08 — audited implementation of secp256k1 + schnorr in pure typescript
* [noble-secp256k1](https://github.com/paulmillr/noble-secp256k1) ⭐ 888 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-30 — alternative implementation of secp256k1: size is only 4KB gzipped; lots of comments, very valuable for learning how algorithms work
* [scure-btc-signer](https://github.com/paulmillr/scure-btc-signer) ⭐ 241 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-31 — audited & minimal library for creating, signing & decoding Bitcoin transactions. With Schnorr, Taproot, UTXO & PSBT.
...
* [toll-booth](https://github.com/forgesworn/toll-booth) ⭐ 2 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-07 - HTTP 402 payment middleware for Node.js; gates any API behind Lightning, Cashu, or stablecoin payments with five backend options.
...
* [BlockTrail PHP SDK](https://github.com/blocktrail/blocktrail-sdk-php) ⭐ 47 | 🐛 37 | 🌐 PHP | 📅 2024-04-28

## Ruby Libraries

* [Bitcoin-ruby](https://github.com/lian/bitcoin-ruby) ⭐ 921 | 🐛 39 | 🌐 Ruby | 📅 2024-08-19
* [bitcoinrb](https://github.com/chaintope/bitcoinrb) ⭐ 67 | 🐛 1 | 🌐 Ruby | 📅 2026-09-05 - Ruby bitcoin library including script interpreter.
...
* [Rust Bitcoin](https://github.com/rust-bitcoin/rust-bitcoin) ⭐ 2,677 | 🐛 474 | 🌐 Rust | 📅 2026-09-07 - support for de/serialization, parsing and executing on data-structures and network messages.
...
* [pycoin](https://github.com/richardkiss/pycoin) ⭐ 1,440 | 🐛 19 | 🌐 Python | 📅 2026-06-18 - Python library for Bitcoin keys, signatures, transactions. Includes full VM implementation and tools for manipulating keys (ku) and transactions (tx).
...
* [bitcoin\_tools](https://github.com/sr-gi/bitcoin_tools) ⭐ 314 | 🐛 7 | 🌐 Python | 📅 2022-01-30 - Python library for building and analyzing transactions and scripts (both standard and custom). Comes along with a UTXO set analysis tool. Includes several examples and exhaustive documentation.
...
* [XChange](https://github.com/knowm/XChange) ⭐ 4,080 | 🐛 189 | 🌐 Java | 📅 2026-09-04 - Library that provides a simple and consistent API for interacting with 50+ Bitcoin currency exchanges.
* [Bitcoin Spring Boot Starter](https://github.com/theborakompanioni/bitcoin-spring-boot-starter) ⭐ 85 | 🐛 16 | 🌐 Java | 📅 2026-09-08 - Bitcoin integration for Spring Boot applications.
...
* [secp256k1.swift](https://github.com/GigaBitcoin/secp256k1.swift) ⭐ 157 | 🐛 3 | 🌐 Swift | 📅 2026-09-03 - Swift package for secp256k1 applications, includes Elliptic Curve operations, Schnorr, ZKP and more for Bitcoin.

## .Net Libraries

* [NBitcoin](https://github.com/MetacoSA/NBitcoin) ⭐ 1,939 | 🐛 113 | 🌐 C# | 📅 2026-09-08 - Comprehensive Bitcoin library for the .NET framework.
...
* [Haskoin-core](https://github.com/haskoin/haskoin-core) ⭐ 535 | 🐛 1 | 🌐 Haskell | 📅 2026-08-31 - Haskoin Core is a library of Bitcoin and Bitcoin Cash functions written in Haskell.

## Playgrounds

* [blockchain-demo](https://github.com/anders94/blockchain-demo/) ⭐ 5,663 | 🐛 11 | 🌐 Pug | 📅 2026-09-03 - A web-based demonstration of blockchain concepts.
...
* [BitcoinABE](https://github.com/bitcoin-abe/bitcoin-abe) ⭐ 977 | 🐛 159 | 🌐 Python | 📅 2023-06-26 - Abe: block browser for Bitcoin and similar currencies.
...
* [nodsig](https://github.com/amenano/nodsig) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-08-27 - Turns your node's blocks into sealed local artifacts: chain questions become offline lookups, and every answer carries a fingerprint anyone can recompute. Python stdlib only.

## Full nodes

* [btcd](https://github.com/btcsuite/btcd/) ⭐ 6,704 | 🐛 347 | 🌐 Go | 📅 2026-09-08 - Go-based full node since 2013.
* [Bitcore](https://github.com/bitpay/bitcore) ⭐ 4,986 | 🐛 61 | 🌐 TypeScript | 📅 2026-08-31 - Formerly just a Nodejs library, now a full node.
...
* [Mastering Bitcoin](https://github.com/bitcoinbook/bitcoinbook) ⭐ 25,300 | 🐛 191 | 🌐 HTML | 📅 2024-12-26
* [Bitcoin Book of BIPs](https://adamdecaf.github.io/bitcoin-bips-book/) - Deployed and complete [BIPs](https://github.com/bitcoin/bips) ⭐ 10,933 | 🐛 60 | 🌐 Wikitext | 📅 2026-09-03, grouped by theme. PDF, ePUB, and web.
* [Bitcoin Protocol Development Curriculum - Chaincode Labs](https://github.com/chaincodelabs/bitcoin-curriculum) ⭐ 702 | 🐛 0 | 📅 2025-08-23.
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,189 | 🐛 106 | 📅 2026-09-02 list thing.
