...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,311 | 🐛 105 | 📅 2026-09-02
...
* [PaperVault](https://github.com/boazeb/papervault) ⭐ 64 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-29 - Offline paper-based secret storage using AES-256-GCM and Shamir's Secret Sharing. Create printable encrypted backups of seed phrases with threshold key splitting.
...
* [Esplora](https://github.com/Blockstream/esplora) ⭐ 1,263 | 🐛 189 | 🌐 JavaScript | 📅 2026-09-02 - Self-hosted blockchain explorer.
...
* [libsecp256k1](https://github.com/bitcoin-core/secp256k1) ⭐ 2,480 | 🐛 156 | 🌐 C | 📅 2026-08-30
* [UltrafastSecp256k1](https://github.com/shrec/UltrafastSecp256k1) ⭐ 52 | 🐛 7 | 🌐 C++ | 📅 2026-09-02 - High-performance `secp256k1` engine with a stable C ABI, CPU, CUDA, OpenCL, embedded, and WebAssembly targets.

## C++ Libraries

* [Libbitcoin](https://libbitcoin.org/)
* [Libbitcoin](https://libbitcoin.info/) - A set of cross platform C++ libraries for building bitcoin applications
* [libwally-core](https://github.com/ElementsProject/libwally-core) ⭐ 307 | 🐛 33 | 🌐 C | 📅 2026-08-27

## JavaScript Libraries

* [Bitcoinjs-lib](https://github.com/bitcoinjs/bitcoinjs-lib) ⭐ 5,997 | 🐛 53 | 🌐 JavaScript | 📅 2026-02-17
* [Bitcore Library](https://github.com/bitpay/bitcore/tree/v8.0.0/packages/bitcore-lib) ⭐ 4,985 | 🐛 55 | 🌐 TypeScript | 📅 2026-08-31
...
* [noble-curves](https://github.com/paulmillr/noble-curves) ⭐ 949 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-31 — audited implementation of secp256k1 + schnorr in pure typescript
* [noble-secp256k1](https://github.com/paulmillr/noble-secp256k1) ⭐ 887 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-30 — alternative implementation of secp256k1: size is only 4KB gzipped; lots of comments, very valuable for learning how algorithms work
...
* [Rust Bitcoin](https://github.com/rust-bitcoin/rust-bitcoin) ⭐ 2,672 | 🐛 468 | 🌐 Rust | 📅 2026-09-02 - support for de/serialization, parsing and executing on data-structures and network messages.
...
* [XChange](https://github.com/knowm/XChange) ⭐ 4,081 | 🐛 194 | 🌐 Java | 📅 2026-07-31 - Library that provides a simple and consistent API for interacting with 50+ Bitcoin currency exchanges.
...
* [secp256k1.swift](https://github.com/GigaBitcoin/secp256k1.swift) ⭐ 157 | 🐛 3 | 🌐 Swift | 📅 2026-08-31 - Swift package for secp256k1 applications, includes Elliptic Curve operations, Schnorr, ZKP and more for Bitcoin.
...
* [blockchain-demo](https://github.com/anders94/blockchain-demo/) ⭐ 5,664 | 🐛 11 | 🌐 Pug | 📅 2026-07-29 - A web-based demonstration of blockchain concepts.
...
* [BitcoinABE](https://github.com/bitcoin-abe/bitcoin-abe) ⭐ 978 | 🐛 159 | 🌐 Python | 📅 2023-06-26 - Abe: block browser for Bitcoin and similar currencies.
...
* [Bitcore](https://github.com/bitpay/bitcore) ⭐ 4,985 | 🐛 55 | 🌐 TypeScript | 📅 2026-08-31 - Formerly just a Nodejs library, now a full node.
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,311 | 🐛 105 | 📅 2026-09-02 list thing.
