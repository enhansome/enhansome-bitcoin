...
* [PaperVault](https://github.com/boazeb/papervault) ⭐ 63 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-29 - Offline paper-based secret storage using AES-256-GCM and Shamir's Secret Sharing. Create printable encrypted backups of seed phrases with threshold key splitting.
...
* [Esplora](https://github.com/Blockstream/esplora) ⭐ 1,262 | 🐛 189 | 🌐 JavaScript | 📅 2026-09-01 - Self-hosted blockchain explorer.
...
* [UltrafastSecp256k1](https://github.com/shrec/UltrafastSecp256k1) ⭐ 52 | 🐛 11 | 🌐 C++ | 📅 2026-08-31 - High-performance `secp256k1` engine with a stable C ABI, CPU, CUDA, OpenCL, embedded, and WebAssembly targets.

## C++ Libraries

* [Libbitcoin](https://libbitcoin.org/)
* [Libbitcoin](https://libbitcoin.info/) - A set of cross platform C++ libraries for building bitcoin applications
* [libwally-core](https://github.com/ElementsProject/libwally-core) ⭐ 307 | 🐛 32 | 🌐 C | 📅 2026-08-27

## JavaScript Libraries

* [Bitcoinjs-lib](https://github.com/bitcoinjs/bitcoinjs-lib) ⭐ 5,997 | 🐛 53 | 🌐 JavaScript | 📅 2026-02-17
* [Bitcore Library](https://github.com/bitpay/bitcore/tree/v8.0.0/packages/bitcore-lib) ⭐ 4,985 | 🐛 54 | 🌐 TypeScript | 📅 2026-08-31
...
* [noble-curves](https://github.com/paulmillr/noble-curves) ⭐ 941 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-31 — audited implementation of secp256k1 + schnorr in pure typescript
...
* [toll-booth](https://github.com/forgesworn/toll-booth) ⭐ 2 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-31 - HTTP 402 payment middleware for Node.js; gates any API behind Lightning, Cashu, or stablecoin payments with five backend options.
...
* [Rust Bitcoin](https://github.com/rust-bitcoin/rust-bitcoin) ⭐ 2,671 | 🐛 473 | 🌐 Rust | 📅 2026-09-01 - support for de/serialization, parsing and executing on data-structures and network messages.
...
* [Bitcore](https://github.com/bitpay/bitcore) ⭐ 4,985 | 🐛 54 | 🌐 TypeScript | 📅 2026-08-31 - Formerly just a Nodejs library, now a full node.
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,975 | 🐛 105 | 📅 2026-08-21 list thing.
