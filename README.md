...
* [libsecp256k1](https://github.com/bitcoin-core/secp256k1) ⭐ 2,482 | 🐛 157 | 🌐 C | 📅 2026-09-11
...
* [Bitcore Library](https://github.com/bitpay/bitcore/tree/v8.0.0/packages/bitcore-lib) ⭐ 4,986 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-11
...
* [Rust Bitcoin](https://github.com/rust-bitcoin/rust-bitcoin) ⭐ 2,678 | 🐛 486 | 🌐 Rust | 📅 2026-09-11 - support for de/serialization, parsing and executing on data-structures and network messages.
...
* [Bitcoin Spring Boot Starter](https://github.com/theborakompanioni/bitcoin-spring-boot-starter) ⭐ 85 | 🐛 16 | 🌐 Java | 📅 2026-09-11 - Bitcoin integration for Spring Boot applications.
...
* [btcd](https://github.com/btcsuite/btcd/) ⭐ 6,704 | 🐛 348 | 🌐 Go | 📅 2026-09-11 - Go-based full node since 2013.
* [Bitcore](https://github.com/bitpay/bitcore) ⭐ 4,986 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-11 - Formerly just a Nodejs library, now a full node.
...
* [Bitcoin Book of BIPs](https://adamdecaf.github.io/bitcoin-bips-book/) - Deployed and complete [BIPs](https://github.com/bitcoin/bips) ⭐ 10,933 | 🐛 62 | 🌐 Wikitext | 📅 2026-09-10, grouped by theme. PDF, ePUB, and web.
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,088 | 🐛 106 | 📅 2026-09-02 list thing.
