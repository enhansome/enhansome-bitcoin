...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 510,842 | 🐛 107 | 📅 2026-09-02
...
* [bx](https://github.com/libbitcoin/libbitcoin-explorer) ⭐ 643 | 🐛 21 | 🌐 C++ | 📅 2026-09-26 - Bitcoin Command Line Tool.
...
* [PaperVault](https://github.com/boazeb/papervault) ⭐ 66 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-19 - Offline paper-based secret storage using AES-256-GCM and Shamir's Secret Sharing. Create printable encrypted backups of seed phrases with threshold key splitting.
...
* [Esplora](https://github.com/Blockstream/esplora) ⭐ 1,267 | 🐛 189 | 🌐 JavaScript | 📅 2026-09-25 - Self-hosted blockchain explorer.
* [Insight](https://github.com/bitpay/insight) ⭐ 1,194 | 🐛 211 | 🌐 TypeScript | 📅 2026-08-31
...
* [libsecp256k1](https://github.com/bitcoin-core/secp256k1) ⭐ 2,484 | 🐛 159 | 🌐 C | 📅 2026-09-25
* [UltrafastSecp256k1](https://github.com/shrec/UltrafastSecp256k1) ⭐ 55 | 🐛 6 | 🌐 C++ | 📅 2026-09-26 - High-performance `secp256k1` engine with a stable C ABI, CPU, CUDA, OpenCL, embedded, and WebAssembly targets.
...
* [Bitcoinjs-lib](https://github.com/bitcoinjs/bitcoinjs-lib) ⭐ 6,002 | 🐛 56 | 🌐 JavaScript | 📅 2026-02-17
* [Bitcore Library](https://github.com/bitpay/bitcore/tree/v8.0.0/packages/bitcore-lib) ⭐ 4,986 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-23
...
* [toll-booth](https://github.com/forgesworn/toll-booth) ⭐ 2 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-24 - HTTP 402 payment middleware for Node.js; gates any API behind Lightning, Cashu, or stablecoin payments with five backend options.
...
* [Rust Bitcoin](https://github.com/rust-bitcoin/rust-bitcoin) ⭐ 2,682 | 🐛 464 | 🌐 Rust | 📅 2026-09-26 - support for de/serialization, parsing and executing on data-structures and network messages.
...
* [XChange](https://github.com/knowm/XChange) ⭐ 4,082 | 🐛 189 | 🌐 Java | 📅 2026-09-04 - Library that provides a simple and consistent API for interacting with 50+ Bitcoin currency exchanges.
* [Bitcoin Spring Boot Starter](https://github.com/theborakompanioni/bitcoin-spring-boot-starter) ⭐ 85 | 🐛 16 | 🌐 Java | 📅 2026-09-22 - Bitcoin integration for Spring Boot applications.
...
* [secp256k1.swift](https://github.com/GigaBitcoin/secp256k1.swift) ⭐ 157 | 🐛 4 | 🌐 Swift | 📅 2026-09-24 - Swift package for secp256k1 applications, includes Elliptic Curve operations, Schnorr, ZKP and more for Bitcoin.

## .Net Libraries

* [NBitcoin](https://github.com/MetacoSA/NBitcoin) ⭐ 1,939 | 🐛 113 | 🌐 C# | 📅 2026-09-25 - Comprehensive Bitcoin library for the .NET framework.
...
* [Blockparser+SQL](https://github.com/mcdee/blockparser) ⭐ 61 | 🐛 0 | 🌐 C++ | 📅 2021-10-05 - Fast, quick and dirty bitcoin blockchain parser.
...
* [nodsig](https://github.com/amenano/nodsig) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-26 - Turns your node's blocks into sealed local artifacts: chain questions become offline lookups, and every answer carries a fingerprint anyone can recompute. Python stdlib only.

## Full nodes

* [btcd](https://github.com/btcsuite/btcd/) ⭐ 6,712 | 🐛 350 | 🌐 Go | 📅 2026-09-16 - Go-based full node since 2013.
* [Bitcore](https://github.com/bitpay/bitcore) ⭐ 4,986 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-23 - Formerly just a Nodejs library, now a full node.
...
* [Bitcoin Book of BIPs](https://adamdecaf.github.io/bitcoin-bips-book/) - Deployed and complete [BIPs](https://github.com/bitcoin/bips) ⭐ 10,949 | 🐛 57 | 🌐 Wikitext | 📅 2026-09-25, grouped by theme. PDF, ePUB, and web.
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 510,842 | 🐛 107 | 📅 2026-09-02 list thing.
