...
* [PaperVault](https://github.com/boazeb/papervault) ⭐ 64 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-03 - Offline paper-based secret storage using AES-256-GCM and Shamir's Secret Sharing. Create printable encrypted backups of seed phrases with threshold key splitting.
...
* [Esplora](https://github.com/Blockstream/esplora) ⭐ 1,263 | 🐛 190 | 🌐 JavaScript | 📅 2026-09-03 - Self-hosted blockchain explorer.
...
* [libsecp256k1](https://github.com/bitcoin-core/secp256k1) ⭐ 2,479 | 🐛 156 | 🌐 C | 📅 2026-08-30
* [UltrafastSecp256k1](https://github.com/shrec/UltrafastSecp256k1) ⭐ 52 | 🐛 11 | 🌐 C++ | 📅 2026-09-03 - High-performance `secp256k1` engine with a stable C ABI, CPU, CUDA, OpenCL, embedded, and WebAssembly targets.

## C++ Libraries

* [Libbitcoin](https://libbitcoin.org/)
* [Libbitcoin](https://libbitcoin.info/) - A set of cross platform C++ libraries for building bitcoin applications
* [libwally-core](https://github.com/ElementsProject/libwally-core) ⭐ 307 | 🐛 33 | 🌐 C | 📅 2026-09-03

## JavaScript Libraries

* [Bitcoinjs-lib](https://github.com/bitcoinjs/bitcoinjs-lib) ⭐ 5,996 | 🐛 53 | 🌐 JavaScript | 📅 2026-02-17
* [Bitcore Library](https://github.com/bitpay/bitcore/tree/v8.0.0/packages/bitcore-lib) ⭐ 4,985 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-31
...
* [Rust Bitcoin](https://github.com/rust-bitcoin/rust-bitcoin) ⭐ 2,671 | 🐛 468 | 🌐 Rust | 📅 2026-09-03 - support for de/serialization, parsing and executing on data-structures and network messages.
...
* [XChange](https://github.com/knowm/XChange) ⭐ 4,082 | 🐛 186 | 🌐 Java | 📅 2026-09-03 - Library that provides a simple and consistent API for interacting with 50+ Bitcoin currency exchanges.
...
* [secp256k1.swift](https://github.com/GigaBitcoin/secp256k1.swift) ⭐ 157 | 🐛 4 | 🌐 Swift | 📅 2026-09-03 - Swift package for secp256k1 applications, includes Elliptic Curve operations, Schnorr, ZKP and more for Bitcoin.
...
* [btcd](https://github.com/btcsuite/btcd/) ⭐ 6,705 | 🐛 344 | 🌐 Go | 📅 2026-08-26 - Go-based full node since 2013.
* [Bitcore](https://github.com/bitpay/bitcore) ⭐ 4,985 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-31 - Formerly just a Nodejs library, now a full node.
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,634 | 🐛 105 | 📅 2026-09-02 list thing.
