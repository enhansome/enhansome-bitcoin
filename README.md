...
* [UltrafastSecp256k1](https://github.com/shrec/UltrafastSecp256k1) ⭐ 52 | 🐛 1 | 🌐 C++ | 📅 2026-09-15 - High-performance `secp256k1` engine with a stable C ABI, CPU, CUDA, OpenCL, embedded, and WebAssembly targets.
...
* [Bitcore Library](https://github.com/bitpay/bitcore/tree/v8.0.0/packages/bitcore-lib) ⭐ 4,986 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-16
...
* [Rust Bitcoin](https://github.com/rust-bitcoin/rust-bitcoin) ⭐ 2,679 | 🐛 469 | 🌐 Rust | 📅 2026-09-15 - support for de/serialization, parsing and executing on data-structures and network messages.
...
* [Bitcoin Spring Boot Starter](https://github.com/theborakompanioni/bitcoin-spring-boot-starter) ⭐ 85 | 🐛 14 | 🌐 Java | 📅 2026-09-16 - Bitcoin integration for Spring Boot applications.
...
* [NBitcoin](https://github.com/MetacoSA/NBitcoin) ⭐ 1,939 | 🐛 114 | 🌐 C# | 📅 2026-09-14 - Comprehensive Bitcoin library for the .NET framework.
...
* [btcd](https://github.com/btcsuite/btcd/) ⭐ 6,707 | 🐛 348 | 🌐 Go | 📅 2026-09-11 - Go-based full node since 2013.
* [Bitcore](https://github.com/bitpay/bitcore) ⭐ 4,986 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-16 - Formerly just a Nodejs library, now a full node.
...
* [Mastering Bitcoin](https://github.com/bitcoinbook/bitcoinbook) ⭐ 25,315 | 🐛 191 | 🌐 HTML | 📅 2024-12-26
* [Bitcoin Book of BIPs](https://adamdecaf.github.io/bitcoin-bips-book/) - Deployed and complete [BIPs](https://github.com/bitcoin/bips) ⭐ 10,940 | 🐛 59 | 🌐 Wikitext | 📅 2026-09-14, grouped by theme. PDF, ePUB, and web.
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,670 | 🐛 106 | 📅 2026-09-02 list thing.
