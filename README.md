...
* [libsecp256k1](https://github.com/bitcoin-core/secp256k1) ⭐ 2,482 | 🐛 160 | 🌐 C | 📅 2026-09-07
* [UltrafastSecp256k1](https://github.com/shrec/UltrafastSecp256k1) ⭐ 52 | 🐛 3 | 🌐 C++ | 📅 2026-09-07 - High-performance `secp256k1` engine with a stable C ABI, CPU, CUDA, OpenCL, embedded, and WebAssembly targets.
...
* [Bitcore Library](https://github.com/bitpay/bitcore/tree/v8.0.0/packages/bitcore-lib) ⭐ 4,986 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-31
...
* [noble-curves](https://github.com/paulmillr/noble-curves) ⭐ 953 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-31 — audited implementation of secp256k1 + schnorr in pure typescript
...
* [toll-booth](https://github.com/forgesworn/toll-booth) ⭐ 2 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-07 - HTTP 402 payment middleware for Node.js; gates any API behind Lightning, Cashu, or stablecoin payments with five backend options.
...
* [Rust Bitcoin](https://github.com/rust-bitcoin/rust-bitcoin) ⭐ 2,678 | 🐛 472 | 🌐 Rust | 📅 2026-09-07 - support for de/serialization, parsing and executing on data-structures and network messages.
...
* [Bitcoin Spring Boot Starter](https://github.com/theborakompanioni/bitcoin-spring-boot-starter) ⭐ 85 | 🐛 15 | 🌐 Java | 📅 2026-09-06 - Bitcoin integration for Spring Boot applications.
...
* [NBitcoin](https://github.com/MetacoSA/NBitcoin) ⭐ 1,939 | 🐛 114 | 🌐 C# | 📅 2026-09-07 - Comprehensive Bitcoin library for the .NET framework.
...
* [btcd](https://github.com/btcsuite/btcd/) ⭐ 6,704 | 🐛 344 | 🌐 Go | 📅 2026-09-04 - Go-based full node since 2013.
* [Bitcore](https://github.com/bitpay/bitcore) ⭐ 4,986 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-31 - Formerly just a Nodejs library, now a full node.
...
* [Bitcoin Book of BIPs](https://adamdecaf.github.io/bitcoin-bips-book/) - Deployed and complete [BIPs](https://github.com/bitcoin/bips) ⭐ 10,932 | 🐛 58 | 🌐 Wikitext | 📅 2026-09-03, grouped by theme. PDF, ePUB, and web.
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 503,924 | 🐛 106 | 📅 2026-09-02 list thing.
