...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 495,638 | 🐛 100 | 📅 2026-06-30
...
* [PaperVault](https://github.com/boazeb/papervault) ⭐ 62 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-14 - Offline paper-based secret storage using AES-256-GCM and Shamir's Secret Sharing. Create printable encrypted backups of seed phrases with threshold key splitting.
...
* [Esplora](https://github.com/Blockstream/esplora) ⭐ 1,260 | 🐛 189 | 🌐 JavaScript | 📅 2026-08-13 - Self-hosted blockchain explorer.
...
* [libsecp256k1](https://github.com/bitcoin-core/secp256k1) ⭐ 2,473 | 🐛 153 | 🌐 C | 📅 2026-08-04
...
* [Bitcore Library](https://github.com/bitpay/bitcore/tree/v8.0.0/packages/bitcore-lib) ⭐ 4,990 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-06
...
* [noble-curves](https://github.com/paulmillr/noble-curves) ⭐ 935 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-14 — audited implementation of secp256k1 + schnorr in pure typescript
* [noble-secp256k1](https://github.com/paulmillr/noble-secp256k1) ⭐ 881 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-14 — alternative implementation of secp256k1: size is only 4KB gzipped; lots of comments, very valuable for learning how algorithms work
* [scure-btc-signer](https://github.com/paulmillr/scure-btc-signer) ⭐ 237 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-14 — audited & minimal library for creating, signing & decoding Bitcoin transactions. With Schnorr, Taproot, UTXO & PSBT.
...
* [toll-booth](https://github.com/forgesworn/toll-booth) ⭐ 2 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-13 - HTTP 402 payment middleware for Node.js; gates any API behind Lightning, Cashu, or stablecoin payments with five backend options.
...
* [Rust Bitcoin](https://github.com/rust-bitcoin/rust-bitcoin) ⭐ 2,654 | 🐛 482 | 🌐 Rust | 📅 2026-08-14 - support for de/serialization, parsing and executing on data-structures and network messages.
...
* [Bitcore](https://github.com/bitpay/bitcore) ⭐ 4,990 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-06 - Formerly just a Nodejs library, now a full node.
...
* [Mastering Bitcoin](https://github.com/bitcoinbook/bitcoinbook) ⭐ 25,289 | 🐛 191 | 🌐 HTML | 📅 2024-12-26
...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,638 | 🐛 100 | 📅 2026-06-30 list thing.
